...
declare -Ag CONFIG_DEFAULTS=(
  ...
  [SUPPRESSION_MEDIA_WRITER]="false"
  [SUPPRESSION_CARTES]="false"
  [SUPPRESSION_LIBREOFFICE]="false"
  [SUPPRESSION_NUMERISEUR]="false"
  [SUPPRESSION_MACHINES]="false"
  [SUPPRESSION_CAMERA]="false"
  [SUPPRESSION_CONNEXIONS]="false"
  [SUPPRESSION_CONTROLE_PARENTAL]="false"
  [SUPPRESSION_VISITE_GUIDEE]="false"
  [SUPPRESSION_AIDE]="false"
...
resolve_config_dependencies() {
  ...
  if [[ "$INSTALL_CACHYOS" != "true" && "$HIDE_GRUB_AFTER_CACHYOS" == "true" ]]; then
    log_info "HIDE_GRUB_AFTER_CACHYOS=true est ignoré car INSTALL_CACHYOS=false."
  fi
}
